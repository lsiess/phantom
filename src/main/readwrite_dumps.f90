...
subroutine write_fulldump(t,dumpfile,ntotal,iorder,sphNG)
 use dim,   only:maxp,maxvxyzu,maxalpha,ndivcurlv,ndivcurlB,maxgrav,gravity,use_dust,&
                   track_lum,use_dustgrowth,store_dust_temperature,gr,do_nucleation,do_condensation,&
 ...
 do ipass=1,2
    do k=1,ndatatypes
       ...
       if (do_condensation) call write_array(1,condensation,condensation_label,n_condensation,npart,k,ipass,idump,nums,nerr)
...
subroutine read_phantom_arrays(i1,i2,noffset,narraylengths,nums,npartread,npartoftype,&
 ...
 use part,       only:xyzh,xyzh_label,vxyzu,vxyzu_label,dustfrac,dustfrac_label,abundance,abundance_label, &
                        ...
                        condensation,condensation_label,n_condensation
 use eos_stamatellos, only:ttherm_store,ueqi_store,tau_store,du_store
 ...
 logical               :: got_eosvars(maxeosvars),got_nucleation(n_nucleation),got_condensation(n_condensation),got_ray_tracer
 ...
 call check_arrays(i1,i2,noffset,npartoftype,npartread,nptmass,nsinkproperties,massoftype,&
                     ...
                     got_nucleation,got_condensation,got_iorig,got_iseed_sink,got_apr_level,iphase,xyzh,vxyzu,pxyzu,alphaind, &
