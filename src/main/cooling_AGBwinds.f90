...
!  for use in Phantom by Davide Dionese (2026)
!
! :References:
!   Sembach et al. (2000) ApJ 528, 310
!
! :Owner: Davide Dionese
!
! :Runtime parameters:
!   - abund             : *Chemical abundances*
...
! cool_func, init_cooling_AGB and energ_cooling_AGB subroutines
!
...
! For now gas grain cooling is not active (Tdust = Tgas)
...
!
 if (T_in < 1.d1) then
    ...
    T = T_in
    np1     = rhoi*unit_density/mass_per_H
!
...
! rates(26) = cl59 * ynhe * yne       ! Set to 0
! rates(28) = cl62 * abhp * yn * yne  ! Set to 0
...
!
 ...
 rates(18) = 0.0d0
 rates(19) = 0.0d0
 rates(26) = 0.0d0 ! Already set to 0 by coefficients
 rates(27) = 0.0d0 ! Forcing heII cooling to be 0
 rates(28) = 0.0d0 ! Already set to 0 by coefficients
